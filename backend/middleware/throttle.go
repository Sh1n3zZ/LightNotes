...
func (l *Limiter) RateLimit(ctx context.Context, rds *redis.Client, ip string, path string) bool {
...
var limits = map[string]Limiter{
	...
	"/anonymous/send": {Duration: 60, Count: 10},
	"/anonymous/get":  {Duration: 1, Count: 2},
}
